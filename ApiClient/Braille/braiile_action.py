...
#                     print(f"{lang_data}-{grade_data} status_code: {braille_change.status_code}")
#
...
#                     for cnt in range(3):
#                         cnt += 1
#                         line_spacing_change = self.api_client.user.braille_line_change_api(cnt)
#                         print(f"line: {cnt} status_code: {line_spacing_change.status_code}")
#                         if line_spacing_change.status_code <= 200:
#                             test_result.append(line_spacing_change.status_code)
#
#                         else:
#                             pass
#
...
#                         print(f"letter: {cnt} status_code: {letter_spacing_change.status_code}")
